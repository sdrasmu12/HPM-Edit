...
diplomacy = {
	...
	RANK_2_TENSION_DECAY = -0.05,
	RANK_3_TENSION_DECAY = -0.04,
	RANK_4_TENSION_DECAY = -0.03,
	RANK_5_TENSION_DECAY = -0.02,
	RANK_6_TENSION_DECAY = -0.01,
	...
	TWS_BATTLE_MIN_COUNT = 2, -- At least X battles before the aspect of wins will count
